 ...
 */
public class LogTemp extends javax.swing.JFrame {
    ...
    public void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogTemp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
